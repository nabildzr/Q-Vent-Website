    ...
    <div
                        ...
                        <a href="transaction.html">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2.5">
                                    ...
                                    <span class="item-text text-lg font-medium leading-none">Transaction</span>
                                </div>
                            </div>
                        </a>
                    </li>
                        ...
                        <a href="statistics.html">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2.5">
                                    ...
                                    <span class="item-text text-lg font-medium leading-none">Statistics</span>
                                </div>
                            </div>
                        </a>
                    </li>
                        ...
                        <a href="analytics.html">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2.5">
                                    ...
                                    <span class="item-text text-lg font-medium leading-none">Analytics</span>
                                </div>
                            </div>
                        </a>
                    </li>
                        ...
                        <a href="my-wallet.html">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2.5">
                                    ...
                                    <span class="item-text text-lg font-medium leading-none">My Wallet</span>
                                </div>
                            </div>
                        </a>
                    </li>
                        ...
                        <a href="messages.html">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2.5">
                                    ...
                                    <!--edit-->
                                    <div>
                                        <img src="./assets/images/avatar/profile-xs.png" alt="profile" />
                                    </div>
                                    <!--counter-->
                                    <div class="flex h-5 w-5 items-center justify-center rounded-full bg-success-300">
                                ...
                                <div class="flex items-center space-x-2.5">
                                    <span class="item-ico">
                                        <svg width="18" height="21" viewBox="0 0 18 21" fill="none"
                                            ...
                                            <circle cx="13" cy="14" r="1" fill="#22C55E"
                                                class="path-2" />
                                            <circle cx="5" cy="14" r="1" fill="#22C55E"
                                                class="path-2" />
                                        </svg>
                                    </span>
                        ...
                        <a href="404.html">
                            <div class="flex items-center space-x-2.5">
                                <span class="item-ico">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="10" cy="10" r="10" fill="#1A202C"
                                            class="path-1" />
                                        <path
        ...
        <div class="copy-write-text">
            ...
            <p class="text-sm font-medium text-bgray-700">
                Made with ❤️ by
                <a href="#" target="_blank" class="border-b font-semibold hover:text-blue-600">QuomodoTheme</a>
            </p>
        </div>
    </div>
</aside>
